...
func (d *teamDataSource) ApiToModel(
	...
	return datasource_team.TeamModel{
		...
		DiscordNotificationsServerDiskUsage:  optionalBool(response.DiscordNotificationsServerDiskUsage),
		...
		SmtpNotificationsServerDiskUsage:     optionalBool(response.SmtpNotificationsServerDiskUsage),
