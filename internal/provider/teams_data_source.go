...
func (d *teamsDataSource) apiToModel(
	...
	for _, team := range *teams {
		...
		attributes := map[string]attr.Value{
			...
			"discord_notifications_server_disk_usage": optionalBool(team.DiscordNotificationsServerDiskUsage),
			...
			"smtp_notifications_server_disk_usage":    optionalBool(team.SmtpNotificationsServerDiskUsage),
